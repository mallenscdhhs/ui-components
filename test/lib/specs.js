...
},{"./page-spec.js":167}],2:[function(require,module,exports){
...
var contentTypes = require('components/lib/content-types');
var _ = require('underscore');

module.exports = React.createClass({displayName: 'exports',

  getInitialState: function(){
    var state = _.extend({ title: '', content: [] }, this.props);
    return state;
  },
      ...
      React.createElement("article", null, 
        ...
        React.createElement("section", null, 
          this.state.content.map(function(item, i){
            ...
            return React.createElement(contentTypes[item.type], item.config, item.config.text);
          })
        )
      )
    );
...
},{"components/lib/content-types":3,"react/addons":5,"underscore":166}],5:[function(require,module,exports){
...
},{"components/page.jsx":4,"react/addons":5}]},{},[1]);
